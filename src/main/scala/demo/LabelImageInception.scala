...
object LabelImageInception {
  ...
  def main(args: Array[String]) {
    ...
    // val imageBytes: Array[Byte] = LabelImageUtils.readAllBytesOrExit();

    var image: Tensor = RasterVisionUtils.constructAndExecuteGraphToNormalizeInGeoTrellisRasterVisionImage(Paths.get(imageFile).toString)
    try {
